...
# Team ID:          [ NB_270 ]
# Author List:      [ Muhammad Basil V, Amirul Haqe ]
# Filename:         task_2a.py
...
def start_simulation():
	...
	returnCode,pingTime = sim.simxGetPingTime(client_id)
...
def get_vision_sensor_image(vision_sensor_handle):
	...
	return_code , resolution , image = sim.simxGetVisionSensorImage(client_id,handle,0,sim.simx_opmode_oneshot_wait)

	vision_sensor_image.append(image)
	image_resolution.append(resolution[0])
	image_resolution.append(resolution[1])
...
def transform_vision_sensor_image(vision_sensor_image, image_resolution):
	...
	#covertion to numpy array, resizing, convertion of RGB to BGR, and flipping x-axis
